...
# # With the help of tuple() built in method:-
...
# tup3 = (12, True, "AKHILA", ["J", "K", "L", "SURESH"], ((("PLUTO"), "NEPTUNE"), "MARS"), "EARTH")

# print(tup3[4][0][0][-1::-1])
...
# print(tup4.index(5))
# print(tup4.index(0))
# print(tup4.index('Z'))  #ValueError: tuple.index(x): x not in tuple
